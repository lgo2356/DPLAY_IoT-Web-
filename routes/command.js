...
const pin = [1, 2, 4, 8, 10, 20, 40, 80, 1, 2, 4, 8];
...
function Sensor_control_on(pin_number, sensor) {
    ...
    if(sensor_timer_state === 'OFF') {
        sensor_timer = setInterval(function() {
            console.log('Reading sensor values now');
            buff = main.getBuffer();
            console.log('Timer buffer: ' + buff.toString());
        }, 1000);
        sensor_timer_state = 'ON';
    }
}
...
// let pin_tmp = '';
//
// router.post('/Sensor_value', function(req, res) {
//     let value = buff;
...
router.post('/LED', function(req, res) {
    ...
    switch(msg) {
        ...
        case 'PIN01':
            ...
            break;
        case 'PINALL':
            const command2 = 'EA0341000341FF00DE';
            timer = setInterval(function() {
                console.log('Running...');
                buff = main.getBuffer();
        ...
        case 'PINOFF':
            ...
            client.write('EA03410003410000DE');
            break;
    }
